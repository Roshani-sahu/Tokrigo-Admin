...
const stockData = [
  { id: "#fc5b94", product: "Marie Gold Biscuits", stock: "884 Units", threshold: "100 Units", reorder: "200 Units", status: "In-Stock", supplier: "Mr. Bean", time: "2 Days" },
  { id: "#fc5b94", product: "Marie Gold Biscuits", stock: "50 Units", threshold: "100 Units", reorder: "200 Units", status: "Re-Order", supplier: "Mr. Bean", time: "2 Days" },
  { id: "#fc5b94", product: "Marie Gold Biscuits", stock: "0 Units", threshold: "100 Units", reorder: "200 Units", status: "Out of Stock", supplier: "Mr. Bean", time: "2 Days" },
  { id: "#fc5b94", product: "Marie Gold Biscuits", stock: "884 Units", threshold: "100 Units", reorder: "200 Units", status: "In-Stock", supplier: "Mr. Bean", time: "2 Days" },
  { id: "#fc5b94", product: "Marie Gold Biscuits", stock: "884 Units", threshold: "100 Units", reorder: "200 Units", status: "In-Stock", supplier: "Mr. Bean", time: "2 Days" },
  { id: "#fc5b94", product: "Marie Gold Biscuits", stock: "50 Units", threshold: "100 Units", reorder: "200 Units", status: "Re-Order", supplier: "Mr. Bean", time: "2 Days" },
  { id: "#fc5b94", product: "Marie Gold Biscuits", stock: "0 Units", threshold: "100 Units", reorder: "200 Units", status: "Out of Stock", supplier: "Mr. Bean", time: "2 Days" },
            ...
            {stockData.map((item, i) => (
              <tr key={i} className="border-b last:border-none">
                ...
                <td className="px-4 py-3">
                  <span className={`px-3 py-1 rounded-full text-[11px] font-medium ${statusStyles[item.status]}`}>
                    {item.status}
                  </span>
                </td>
